    ...
    <body>
        <div class="slider-area">
            <div class="slider-active owl-dot-style owl-carousel">
                <?php
                    $banner_res=mysqli_query($con,"SELECT * FROM banner WHERE status=1 ORDER BY banner_serial_number");
                    while($banner_row=mysqli_fetch_assoc($banner_res)){
                ?>
                        <div class="single-slider pt-210 pb-220 bg-img" style="background-image:url(<?php echo BANNER_IMAGE_SITE_PATH.$banner_row['image'];?>);">
                            <div class="container">
