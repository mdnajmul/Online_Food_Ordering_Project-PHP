...
<div class="card">
            <div class="card-body">
              ...
              <a href="add_category.php" class="add_link">Add Category</a>
                      ...
                      ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="add_category.php?id=<?php echo $row['id']?>"><span class="badge badge-pill badge-edit edit_clr">Edit</span></a>&nbsp;
