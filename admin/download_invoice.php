<?php
   ...
   //If Admin not login then check user login or not login.If user not login then die this page & not generate pdf.
    ...
    if(isset($_SESSION['ADMIN_LOGIN'])){
        ...
        $order_res=mysqli_fetch_assoc(mysqli_query($con,"SELECT address,zip_code,payment_status,payment_method,added_on FROM order_master WHERE id='$order_id'"));
    }else{
    ...
    <body>
        <div class="wishlist-table table-responsive">
            <table>
                ...
                <span style="color:green; font-size:18px; font-weight:bold;">Food Online Ltd.</span><br/><span style="color:black; font-size:18px; font-weight:normal;"><strong>ORDER DETAILS:</strong></span><br/>
